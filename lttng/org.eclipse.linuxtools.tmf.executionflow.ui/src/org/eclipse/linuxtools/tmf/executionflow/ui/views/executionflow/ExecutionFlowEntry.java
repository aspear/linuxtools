...
import org.eclipse.linuxtools.internal.tmf.executionflow.views.common.EventIterator;
...
public class ExecutionFlowEntry implements ITimeGraphEntry {
    ...
    @Override
    public List<ExecutionFlowEntry> getChildren() {
        return fChildren;
    }
     ...
     *            The child entry
     */
    public void addChild(ExecutionFlowEntry child) {
        child.fParent = this;
        fChildren.add(child);
    }
}
