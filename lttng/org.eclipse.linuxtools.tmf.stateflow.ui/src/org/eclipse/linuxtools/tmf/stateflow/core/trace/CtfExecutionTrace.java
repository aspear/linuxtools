...
public class CtfExecutionTrace extends CtfTmfTrace {
    ...
    public IStatus validate(final IProject project, final String path) {
        ...
        try {
        	...
        	return new Status(IStatus.ERROR, Activator.PLUGIN_ID,"This is not a valid CTF trace: " + e.getMessage()); //FIXME AARON
        }
        ...
        return new Status(IStatus.ERROR, Activator.PLUGIN_ID,"This is not a valid execution trace, dom='" + dom + "'"); //FIXME AARON
    }
